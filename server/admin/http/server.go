...
func New(ctx context.Context, listen string, indexer indexer.Interface, ingester ingestion.Ingester, options ...ServerOption) (*Server, error) {
	...
	adminHandler := handler.New(ctx, indexer, ingester)
